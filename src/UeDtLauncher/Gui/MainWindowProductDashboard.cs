    ...
    private Control Hero(double height)
    {
        ...
        overlay.Children.Add(new StackPanel
        {
            ...
            Children =
            {
                ...
                new TextBlock { Text = IsDeveloper ? $"{_config.Environment} · {_config.Channel} · {_config.TargetPlatform}" : "안정화 최신 버전", FontSize = 16, Foreground = B("#93C5FD"), TextWrapping = TextWrapping.Wrap },
